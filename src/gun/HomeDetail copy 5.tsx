...
// Gun framing per stage — unchanged: same positions, widths, rotations.
const GUN_POSE = {
...
export const HomeDetail = ({ stage }: HomeDetailProps) => {
  ...
  // Gates ellipses + callouts behind the gun's arrival, confirmed via
  // Framer Motion's own onLayoutAnimationComplete — not a guessed delay.
          ...
          >
            ...
            {activeCallouts.map((c) => (
              <motion.div
                ...
                transition={{ duration: 0.85, delay: c.delay + 0.2, ease: [0.16, 1, 0.3, 1] }}
